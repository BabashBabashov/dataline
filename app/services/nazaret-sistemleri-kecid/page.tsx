      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-secondary p-8 md:p-10 rounded-lg shadow-lg mb-12">
            <h2 className="text-xl font-bold text-primary mb-4">Keçid nəzarət sistemləri</h2>
            <p className="text-lg leading-relaxed text-foreground">
              Dataline şirkəti müasir Biometrik sistemlər, kartlı keçid, barmaq izi, üz tanıma ilə keçid sistemləri təklif edir. Ofislərdə qurulan bu sistem personalın işə davamiyyətinə, işə giriş-çıxış saatlarına nəzarət etməyə imkan verir və bütün məlumatlar yaddaşa yazılır.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-accent/10 p-6 rounded-lg border-l-4 border-accent mb-8">
              <p className="text-primary font-medium text-lg leading-relaxed">
                Sistem proqram təminatı ilə birgə qurula bilir. Proqram komputerə qurulur və hər ayın sonuna, yaxud günlük, aylıq hesabatlar verə bilər.
              </p>
            </div>
