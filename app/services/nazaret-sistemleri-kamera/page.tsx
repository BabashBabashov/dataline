      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-secondary p-8 md:p-10 rounded-lg shadow-lg mb-12">
            <h2 className="text-xl font-bold text-primary mb-4">Video müşahidə sistemləri</h2>
            <p className="text-lg leading-relaxed text-foreground">
              Dataline şirkəti tərəfindən kamera video müşahidə sistemlərinin peşəkar quraşdırılması həyata keçirilir. Müasir texnologiyalar və yüksək keyfiyyətli avadanlıqlar vasitəsi ilə obyektinizin təhlükəsizliyini maksimum səviyyəyə qaldırırıq.
            </p>
            <div className="mt-6 p-4 bg-accent/10 rounded-lg border-l-4 border-accent">
              <p className="text-primary font-semibold">
                İstənilən nöqtədən internet üzərindən interaktiv İP domofonlar və kameralar vasitəsi ilə nəzarət etmə imkanı yaradılır.
              </p>
            </div>
          </div>
